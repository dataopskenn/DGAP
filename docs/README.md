...
I keep deep-dive documentation here for my decision‑grade raw acquisition pipeline. Start with this index to explore the architecture, sprint guides, data layout, and operations.
...
- Sprint 2 (Fetch): my transport‑only layer — [fetch_guide.md](fetch_guide.md)
- Sprint 1 (Ingestion): my hashing + ledger design — [ingestion_guide.md](ingestion_guide.md)
- Data Layout & Provenance: my canonical directories and sidecars — [data_layout.md](data_layout.md)
...
2. Follow [fetch_guide.md](fetch_guide.md) to see my staging → atomic commit flow.
